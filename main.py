...
with col1:
    st.image("img.png")
with col2:
    st.markdown("<h1 style = 'margin-bottom:-5%;'>Document<span style= 'color: #F55F0E;'> Explorer</span></h1>", unsafe_allow_html=True)
    st.markdown("<p style = 'padding-bottom: 10%'>~Effortless Research</p>",unsafe_allow_html=True)
