...
def sidebar():
    with st.sidebar:
        ...
        st.subheader("ABOUT:")
        st.markdown("DocumentExplorer empowers professionals with AI technology, "
                    " allowing you to upload large documents and receive quick and "
        ...
        st.markdown("<p style = 'cursor: default;'>1.Enter your Open AI's API KEY."
                    "<br>2. Upload your document through the upload button."
